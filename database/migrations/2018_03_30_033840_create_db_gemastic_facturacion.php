     ...
     public function up()
      {
          ...
          Schema::create('impuestos',function($table){
            $table->string('ID',4)->required(); //('ID',3)
          ...
          Schema::create('ventas',function($table){
            ...
            $table->string('ID_Impuesto',4)->required();
            $table->unsignedInteger('ID_Negocio')->required();
          ...
          Schema::create('nota_creditos',function($table){
            $table->increments('ID');
            ...
            $table->string('Numero',8)->required();
            $table->dateTime('Fecha')->required();
            $table->string('SerieReferencia',4)->required();
            $table->string('NumeroReferencia',8)->required();
            $table->unsignedInteger('ID_Cliente')->required();
            $table->float('MontoBruto',15,4)->required();
            $table->float('Impuesto',15,4)->required();
            $table->float('Total',15,4)->required();
          ...
          Schema::create('nota_debitos',function($table){
            $table->increments('ID');
          ...
          Schema::create('detalle_nota_creditos',function($table){

            $table->dateTime('FechaCreacion')->required();
            $table->dateTime('FechaModificacion')->required();
            $table->unsignedInteger('ID_Usuario')->required();

            $table->unsignedInteger('ID')->required();
            $table->unsignedInteger('ID_Producto')->required();
            $table->unsignedInteger('ID_UnidadMedida')->required();
            $table->float('Cantidad',10,2)->required();
            $table->float('PrecioUnitario',15,4)->required();
            ...
            $table->primary(['ID','ID_Producto','ID_UnidadMedida']);

            $table->foreign('ID')->references('ID')->on('nota_creditos');
            $table->foreign('ID_Producto')->references('ID')->on('productos');
            $table->foreign('ID_UnidadMedida')->references('ID')->on('unidad_medidas');
          });

          Schema::create('detalle_nota_debitos',function($table){
            ...
            $table->foreign('ID')->references('ID')->on('nota_debitos');
            $table->foreign('ID_Producto')->references('ID')->on('productos');
            $table->foreign('ID_UnidadMedida')->references('ID')->on('unidad_medidas');
          });
      ...
      public function down()
      {
          ...
          Schema::drop('nota_creditos');
          Schema::drop('nota_debitos');
          Schema::drop('detalle_nota_creditos');
          Schema::drop('detalle_nota_debitos');
