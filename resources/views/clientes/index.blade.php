          ...
          <div class="row">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="TipoDocumento" required>
      ...
      <div class="modal-body" style="padding:40px 50px;">
          ...
          <div class="row">
              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-address-card-o"></i></span>
                  <input type="text" class="form-control" name="RazonSocial" placeholder="Razon Social" value="{{ $cliente->RazonSocial }}" required>
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-address-card-o"></i></span>
                  <select class="form-control select2" style="width: 100%;" name="ID_Ubigeo" required>
                    <option value="" select >seleccionar ubigeo</opcion>
                    @foreach($ubigeos as $ubigeo)
                      <option value="{!! $ubigeo->ID !!}" @if($ubigeo->ID==$cliente->ID_Ubigeo) selected @endif>{{ $ubigeo->Nombre }} {{ $ubigeo->CodDepartamento}} {{ $ubigeo->CodProvincia}} {{ $ubigeo->CodDistrito}}</opcion>
                    @endforeach
                  </select>
                </div>
                <!-- /.input group -->
